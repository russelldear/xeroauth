...
oauth.getOAuthAccessToken('OAUTHTOKENKEYFROMPREVIOUS', 'OAUTHTOKENSECRETFROMPREVIOUS', 'VERIFICATIONCODE', function(error, access_token, access_token_secret, accessResults) {
